...
//Log.e("123456789","qqqqqqqqqqqqq");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.e("1234567","sdjfdlsjfldsjldjljdl");
        /*拿到传递过来的ip和端口号*/
        ip = intent.getStringExtra(MainActivity.SERVER_IP);
        port = intent.getStringExtra(Integer.toString(MainActivity.SERVER_PORT));
                ...
                public void run() {
                    try {
                        ...
                        if (outputStream != null) {
                            Log.e("1234567890","dsjfsdhfkldhslkfs");
